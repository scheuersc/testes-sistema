...
public class TestSelenium {
	...
	@Test
	public void testLoginInvalidoFirefox() {
		...
		browser.get("http://192.168.124.128:10100");
		...
		System.out.println("aqui-> " + results);
		assertEquals("Usuário ou senha invalidos!", results);
		browser.quit();
	}
	
	@Test
	public void testLoginInvalidoChrome() {
	...
	@Test
	public void testLoginCorretoFirefox() {
		...
		System.out.println("aqui-> " + results);
		assertEquals("Clique na banca que deseja acessar:", results);
		browser.quit();
	}
	...
	@Test
	public void testLoginSQLInjectFirefox() {
		...
		browser.get("http://192.168.124.128:10100");
		browser.findElement(By.name("frmLogin")).findElement(By.name("txtUsuario")).sendKeys("\' OR 1=1 --");//não permitir inserir o apostrofe (') e usar o PreparedStatement para gerar a query
		browser.findElement(By.name("frmLogin")).findElement(By.name("txtSenha")).sendKeys("");
		browser.findElement(By.name("frmLogin")).findElement(By.name("cmdEntrar")).click();
	...
	@Test
	public void testLoginSQLInjectChrome() {
	...
	@Test
	public void testLoginForcaBrutaFirefox() {
		...
		System.out.println("Permitiu o acesso!");
		assertEquals("Clique na banca que deseja acessar:", results);
		browser.quit();
	}
	
	@Test
	public void testLoginForcaBrutaChrome() {
